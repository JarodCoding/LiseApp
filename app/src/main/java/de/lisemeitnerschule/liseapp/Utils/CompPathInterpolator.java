 ...
 * </pre></blockquote></p>
 */
public class CompPathInterpolator implements Interpolator {
     ...
     */
    public CompPathInterpolator(Path path) {
        initPath(path);
    }
     ...
     */
    public CompPathInterpolator(float controlX, float controlY) {
     ...
     */
    public CompPathInterpolator(float controlX1, float controlY1, float controlX2, float controlY2) {
    ...
    private void initPath(Path path) {
        float[] pointComponents = null;
        try {
            Method approximate = Path.class.getMethod("approximate", float.class);
            pointComponents = (float[])approximate.invoke(path,PRECISION);
